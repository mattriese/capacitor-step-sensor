...
* [`configureFitnessNotifications(...)`](#configurefitnessnotifications)
* [`clearFitnessNotifications()`](#clearfitnessnotifications)
* [`getFitnessNotificationDebugState()`](#getfitnessnotificationdebugstate)
...
| Param         | Type                                                                                                  |
| ------------- | ----------------------------------------------------------------------------------------------------- |
| **`options`** | <code><a href="#configurefitnessnotificationsoptions">ConfigureFitnessNotificationsOptions</a></code> |

--------------------


### clearFitnessNotifications()
...
### getFitnessNotificationDebugState()
...
**Returns:** <code>Promise&lt;<a href="#fitnessnotificationdebugstate">FitnessNotificationDebugState</a>&gt;</code>
...
| **`audit`**                   | <code>BackfillWindowAudit[]</code> | Per-window audit data from the native plugin. Present when backedUp is true. |
| **`totalSurplusDistributed`** | <code>number</code>                | Sum of stepsDistributed across all sources across all windows.               |
...
| Prop                           | Type                                                                                                                                                                                                                                                |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`startAt`**                  | <code>string</code>                                                                                                                                                                                                                                 |
| **`endAt`**                    | <code>string</code>                                                                                                                                                                                                                                 |
...
| **`bySource`**                 | <code><a href="#record">Record</a>&lt; string, { recordCount: number; totalCount: number; phoneStepsInWindow: number; surplusComputed: number; zeroBucketsAvailable: number; bucketsFilledBySource: number; stepsDistributed: number; } &gt;</code> |
...
| **`existingBucketCount`**         | <code>number</code>                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                           |
| **`existingBucketTotalSteps`**    | <code>number</code>                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                           |
| **`perOriginDetail`**             | <code><a href="#record">Record</a>&lt; string, { delta: number; phoneStepsInRange: number; watchSurplus: number; bucketsFilledByOrigin: number; stepsDistributedByOrigin: number; runningBalanceAfter: number; /** Running balance BEFORE this tick's update. */ prevBalance: number; } &gt;</code> |                                                                                                                                                                                                                                           |
| **`filledBucketCount`**           | <code>number</code>                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                           |
| **`filledBucketTotalSteps`**      | <code>number</code>                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                           |
...
| **`lastProcessTime`**             | <code>string \| null</code>                                                                                                                                                                                                                                                                         | Raw hcDeltaTracker.lastProcessTime value at the time of HC processing (null if baseline tick or no HC data).                                                                                                                              |
| **`queryFrom`**                   | <code>string \| null</code>                                                                                                                                                                                                                                                                         | The 30-second-floored value actually used for the DB query (null if no HC processing).                                                                                                                                                    |
| **`rangeSeconds`**                | <code>number \| null</code>                                                                                                                                                                                                                                                                         | Duration between lastProcessTime and now in seconds — how narrow the phone range is.                                                                                                                                                      |
| **`sessionPhoneDeltaTotal`**      | <code>number</code>                                                                                                                                                                                                                                                                                 | Session-level cumulative phone delta total.                                                                                                                                                                                               |
| **`sessionExternalHcDeltaTotal`** | <code>number</code>                                                                                                                                                                                                                                                                                 | Session-level cumulative non-"android" HC origin delta total (all external sources: Samsung Health, Fitbit, etc.).                                                                                                                        |
| **`sessionSurplusDistributed`**   | <code>number</code>                                                                                                                                                                                                                                                                                 | Session-level cumulative surplus steps distributed.                                                                                                                                                                                       |
| **`sessionUptimeSeconds`**        | <code>number \| null</code>                                                                                                                                                                                                                                                                         | Seconds since session start.                                                                                                                                                                                                              |
| **`lastProcessTimeAdvancedBy`**   | <code>string \| null</code>                                                                                                                                                                                                                                                                         | Which origins had non-zero deltas and caused markProcessed to advance (null if no HC processing).                                                                                                                                         |
| **`balanceRestoredValues`**       | <code><a href="#record">Record</a>&lt;string, number&gt; \| null</code>                                                                                                                                                                                                                             | Restored running balance values, only populated on first tick of session.                                                                                                                                                                 |
...
| **`bufferSize`**           | <code>number</code>                  | Current buffer size (max 100).                               |
| **`sessionUptimeSeconds`** | <code>number \| null</code>          | Seconds since session start (from service companion object). |
...
| **`cumulativeLostPhoneCredit`**   | <code>number</code>                                                                                                                                                                                                                                                                                 | Cumulative phone steps that exceeded Samsung's HC delta across all HC-processing ticks since service start. Measures Jensen's inequality effect (per-tick max(0,...) clipping). If this value ≈ (app total - Samsung total), it confirms per-tick clipping is the primary overcounting mechanism. |
| **`lastProcessTime`**             | <code>string \| null</code>                                                                                                                                                                                                                                                                         | Raw hcDeltaTracker.lastProcessTime value at the time of HC processing (null if baseline tick or no HC data).                                                                                                                                                                                      |
| **`queryFrom`**                   | <code>string \| null</code>                                                                                                                                                                                                                                                                         | The 30-second-floored value actually used for the DB query (null if no HC processing).                                                                                                                                                                                                            |
| **`rangeSeconds`**                | <code>number \| null</code>                                                                                                                                                                                                                                                                         | Duration between lastProcessTime and now in seconds — how narrow the phone range is.                                                                                                                                                                                                              |
| **`sessionPhoneDeltaTotal`**      | <code>number</code>                                                                                                                                                                                                                                                                                 | Session-level cumulative phone delta total.                                                                                                                                                                                                                                                       |
...
#### ConfigureFitnessNotificationsOptions

| Prop              | Type                                                   |
| ----------------- | ------------------------------------------------------ |
| **`generatedAt`** | <code>string</code>                                    |
| **`commitments`** | <code>StepSensorFitnessNotificationCommitment[]</code> |


#### StepSensorFitnessNotificationCommitment

| Prop                       | Type                                 |
| -------------------------- | ------------------------------------ |
| **`commitmentId`**         | <code>string</code>                  |
| **`taskName`**             | <code>string</code>                  |
| **`maxOrMin`**             | <code>'max' \| 'min'</code>          |
...
| **`commitments`**        | <code>StepSensorFitnessNotificationCommitment[]</code> |
| **`scheduledReminders`** | <code>ScheduledFitnessReminder[]</code>                |


#### ScheduledFitnessReminder
